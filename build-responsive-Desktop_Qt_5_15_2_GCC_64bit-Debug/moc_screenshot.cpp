...
#include <memory>
#include "../2811_cw1-master_release 3/screenshot.h"
...
QT_MOC_LITERAL(1, 11, 12), // "doScreenshot"
QT_MOC_LITERAL(2, 24, 0) // ""

    },
    "Screenshot\0doScreenshot\0"
};
...
QT_INIT_METAOBJECT const QMetaObject Screenshot::staticMetaObject = { {
    QMetaObject::SuperData::link<ResponsiveWindow::staticMetaObject>(),
...
void *Screenshot::qt_metacast(const char *_clname)
{
    ...
    return ResponsiveWindow::qt_metacast(_clname);
}

int Screenshot::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = ResponsiveWindow::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
    if (_c == QMetaObject::InvokeMetaMethod) {
        if (_id < 1)
