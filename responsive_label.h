...
const QString
        ...
        kRefresh        = "Refresh",
        kLanguage       = "Language";
// Added a langauge and refresh extra widgets
// Language button will take the user to language page of the app when pressed, allowing the user there to change the language of the app
// The refresh button allows the user to refresh the results displayed on the page.
